...
//     private _findRangeCollection: Array<RangeInfo> = new Array<RangeInfo>();
//     private _bFindNextFlag: boolean = false;
...
//     public nRow: int;
//     public nColumn: int;
//     public zSearchedText: string;
//     public nRangeIndex: int;

//     constructor(pzText: string, pnRangeIndex: int, pnRow: int, pnCol: int) {
//         zSearchedText = pzText;
//         nRangeIndex = pnRangeIndex;
//         nRow = pnRow;
//         nColumn = pnCol;
//     }

//     public override string ToString() {
//     return string.Format("zSearchedText:{0}; nGridIndex:{1}; nRow:{2}; nColumn:{3};",
//         zSearchedText, nRangeIndex, nRow, nColumn);
// }
// }

// export class RangeInfo {
//     public grid: wjGrid.FlexGrid;
//     public nBeginRow: int;
//     public nBeginCol: int;
//     public nEndRow: int;
//     public nEndCol: int;

//     constructor(pGrid: wjGrid.FlexGrid, pnBeginRow: int, pnBeginCol: int, pnEndRow: int, pnEndCol: int) {
//         grid = pGrid;
...
// export class CompareTextEventArgs extends wjCore.EventArgs {
//     public findInfo: MatchInfo;

//     private _bMatched: boolean = false;

//     public get bMatched() {
//         return this._bMatched;
//     }

//     public set bMatched(pbVal: boolean) {
//         this._bMatched = pbVal;
//     }

//     private _bHandled: boolean = false;

//     public get bHandled() {
//         return this._bHandled;
//     }

//     public set bHandled(pbVal: boolean) {
//         this._bHandled = pbVal;
//     }

//     public CompareTextEventArgs(pFindInfo: MatchInfo) {
//         findInfo = pFindInfo;
//     }
}
